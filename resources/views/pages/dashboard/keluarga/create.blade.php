...
@section('content')
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div>
                <form class="w-full" id="form-add" action="/data_keluarga" method="post" enctype="multipart/form-data">
                    <div class="sm:flex sm:justify-between sm:space-x-5 sm:w-full">
                        <div class="flex flex-wrap -mx-3 mb-6 sm:w-full">
                            ...
                            <input type="text" name="nomor_kk"
                                ...
                                id="nomor_kk" placeholder="Nomor KK..." onkeypress="return numbersonly(this, event);"
                    ...
                    <div class="sm:flex sm:justify-between sm:space-x-5 sm:w-full">
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 sm:w-full">
                            ...
                            <select name="wilayah_kerja_puskesmas"
                                ...
                                id="wilayah_kerja_puskesmas" required>
                                <option value=""></option>
                    ...
                    <div class="sm:flex sm:justify-between sm:space-x-5 sm:w-full">
                        <div class="flex flex-wrap -mx-3 mb-3 sm:mb-6 sm:w-full">
                            ...
                            <input type="text" name="rt"
                                class="appearance-none block w-full rounded py-3 px-4 leading-tight focus:outline-none bg-gray-300 focus:bg-white"
                                id="rt" placeholder="RT..." maxlength="3"
                        ...
                        <div class="flex flex-wrap -mx-3 mb-6 sm:w-full">
                            ...
                            <input type="text" name="rw"
                                class="appearance-none block w-full rounded py-3 px-4 leading-tight focus:outline-none bg-gray-300 focus:bg-white"
                                id="rw" placeholder="RW..." maxlength="3"
                                onkeypress="return numbersonly(this, event);" required>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-3 w-full justify-end">
                        ...
                        <button type="submit"
                            class="btn-add shadow-lg bg-green-600 hover:bg-green-500 active:bg-green-800 text-white font-bold py-2 px-4 rounded">
                            Simpan
                        </button>
                    </div>
                </form>
                        ...
                        if (response.status === "success") {
                            ...
                            setTimeout(function() {
                                window.location.href =
                                    "/data_anggota_keluarga/create/" + response
                                    .nomor_kk;
                            }, 1500);
                        } else {
                            Swal.fire({
