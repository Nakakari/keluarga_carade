...
<script>
    $(document).ready(function() {
        ...
        $("input[name='soal_ibu_11']").change(function() {
        ...
        $("#btn-add").click(function() {
            // Baduta
            $("input[name='answer[0]']").each(function() {
                if ($(this).is(":checked")) {
                    let val = $(this).val();
                    let point = $("input[name='answer_point[0]']");
                    if (val === '>= 2500 gram') {
                        point.val(1);
                    } else {
                        point.val(0);
            ...
            $("input[name='answer[3]']").each(function() {
                if ($(this).is(":checked")) {
                    let val = $(this).val();
                    let point = $("input[name='answer_point[3]']");
                    if (val === 'Dokter kandungan' || val === 'Dokter umum' || val === 'Bidan' || val === 'Perawat') {
                        point.val(1);
                    } else {
                        point.val(0);
                    }
            ...
            $("input[name='answer[6]']").each(function() {
                if ($(this).is(":checked")) {
                    let val = $(this).val();
                    let point = $("input[name='answer_point[6]']");
                    if (val === 'Ya') {
                        point.val(1);
                    } else {
                        point.val(0);
            ...
            $("input[name='answer[7]']").each(function() {
                if ($(this).is(":checked")) {
                    let val = $(this).val();
                    let point = $("input[name='answer_point[7]']");
                    if (val === 'ASI') {
                        point.val(1);
                    } else {
                        point.val(0);
            ...
            $("input[name='answer[10]']").each(function() {
                if ($(this).is(":checked")) {
                    let val = $(this).val();
                    let point = $("input[name='answer_point[10]']");
                    if (val === 'Ya') {
                        point.val(1);
                    } else {
                        point.val(0);
            ...
            $("input[name='answer[11]']").each(function() {
                if ($(this).is(":checked")) {
                    let val = $(this).val();
                    let point = $("input[name='answer_point[11]']");
                    if (val === 'Lengkap: imunisasi sesuai Usia') {
                        point.val(1);
                    } else {
                        point.val(0);
                    }
            ...
            // Anak SD
            $('input[name="answer[32][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[32]"]');
                if (val === 'Daging: ayam, sapi, kambing atau itik' || val === 'Ikan atau makan seafood') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[33]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[33]"]');
                if (val === 'Sangat sering (setiap hari)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            ...
            $('input[name="answer[37]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[37]"]');
                if (val === 'Ya') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[38]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[38]"]');
                if (val === 'Saat menstruasi (sebelum/Saat/sesudah menstruasi)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[41]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[41]"]');
                if (val === 'Ya') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[43]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[43]"]');
                if (val === 'Kurangnya kadar Hb dalam darah') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[44][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[44]"]');
                if (val === 'Menstruasi' || val === 'Kurangnya konsumsi makanan yang mengandung zat besi atau Fe' || val === 'Perdarahan') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[45][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[45]"]');
                if (val === 'Periksa darah untuk mengetahui kadar Hb' || val === 'Melihat ciri-ciri fisik (kulit dan telapak tangan pucat)' || val === 'Merasa sering pusing') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[46][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[46]"]');
                if (val === 'Daging' || val === 'Ikan' || val === 'Ayam' || val === 'Telur' || val === 'Kentang' || val === 'Kacang Tanah' || val === 'Bayam') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[47][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[47]"]');
                if (val === 'Pusing' || val === 'Mata berkunang-kunang' || val === 'Kelopak mata dan kulit menjadi pucat' || val === 'Lesu' || val === 'Lemah' || val === 'Letih' || val === 'Lelah') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[48]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[48]"]');
                if (val === 'Menurun') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[49]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[49]"]');
                if (val === 'Ya') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[50][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[50]"]');
                if (val === 'Mengkonsumsi ayam, hati dan telur' || val === 'Mengkonsumsi Tablet Tambah Darah (TTD)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[51]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[51]"]');
                if (val === 'Ya') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[52][]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[52]"]');
                if (val === 'Meningkatkan Konsumsi Makanan yang mengandung zat besi atau Fe' || val === 'Menambah pemasukan zat besi dengan minum tablet besi') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            ...
            // Kuesioner Ibu & ibu hamil
            $('input[name="answer[58]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[58]"]');
                if (val === '> 1kal') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[59]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[59]"]');
                if (val === '> 1kal') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[60]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[60]"]');
                if (val === '> 1kal') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[61]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[61]"]');
                if (val === 'Rutin sesuai anjuran dokter/bidan/perawat') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[81]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[81]"]');
                if (val === 'Gangguan tumbuh kembang anak yang tinggi badannya tidak sesuai dengan umur') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[82]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[82]"]');
                if (val === 'Kekurangan gizi dan penyakit infeksi') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[83]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[83]"]');
                if (val === 'Gangguan tumbuh kembang') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[84]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[84]"]');
                if (val === 'Pertumbuhan melambat') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[85]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[85]"]');
                if (val === 'Gangguan kecerdasan dan pertumbuhan fiisk') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[86]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[86]"]');
                if (val === 'Penurunan kekebalan tubuh dan prestasi belajar') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[87]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[87]"]');
                if (val === '0-24bulan/60bulan') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[88]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[88]"]');
                if (val === 'Memberikan makanan tambahan (PMT) pada ibu hamil dan memberikan ASI eksklusif serta MP-ASI pada anak') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[89]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[89]"]');
                if (val === 'Lingkungan dan sumber air harus bersih') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[90]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[90]"]');
                if (val === 'Menyediakan dan memastikan pemberian susu formula untuk anak') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[91]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[91]"]');
                if (val === 'Pemeriksaan KPSP (Kuesioner Pre Skrining Perkembangan)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[92]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[92]"]');
                if (val === 'Makanan yang bergizi: nasi, lauk-pauk (berprotein), sayur-sayuran)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[93]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[93]"]');
                if (val === '1000 hari (umur 0-2 tahun)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[94]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[94]"]');
                if (val === 'Dapat kembali normal bila gizi diperbaiki') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[95]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[95]"]');
                if (val === 'Stunting') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[96]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[96]"]');
                if (val === '≥ 10 meter') {
                    point.val(1);
                } else {
                    point.val(0);
            ...
            $('input[name="answer[97]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[97]"]');
                if (val === 'Air isi' || val === 'Mata air terlindung' || val === 'Sumur bor atau sumur pompa' || val === 'Air ledeng/PDAM' || val === 'Air eceran (yang dijual melalui tanki, air sumur)' || val === 'Hydrant umum' || val === 'Sumur gali terlindung' || val === 'Terminal air' || val === 'Air Permukaan' || val === 'Penampungan air hujan (PAH)') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[98]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[98]"]');
                if (val === 'Ya, Millik sendiri, digunakan ART Sendiri') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[102]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[102]"]');
                if (val === 'Diangkut petugas' || val === 'Dibuang sendiri ke TPS' || val === 'Dibuat Kompos' || val === 'Ditimbun dalam tanah') {
                    point.val(1);
                } else {
                    point.val(0);
                }
            });
            $('input[name="answer[103]"]').each(function() {
                let val = $(this).val();
                let point = $('input[name="answer_point[103]"]');
                if (val === 'Kamar Tidur' || val === 'Dapur/Tempatmasak' || val === 'Ruang keluarga' || val === 'Ruang Tamu') {
                    point.val(1);
                } else {
                    point.val(0);
                }
